...
export default {
  ...
  mounted () {
    axios.get(`http://www.xiongmaoyouxuan.com/api/tab/12?start=0`).then(res => {
  ...
  methods: {
    ...
    loadMore () {
      ...
      axios.get(`http://www.xiongmaoyouxuan.com/api/tab/11/feeds?start=${this.current}&sort=0`).then(res => {
